...
We have a new home for the GWAS summary data: <https://api.opengwas.io/>.
...
- The IEU GWAS database: https://api.opengwas.io/
- API to the IEU GWAS database: https://api.opengwas.io/
