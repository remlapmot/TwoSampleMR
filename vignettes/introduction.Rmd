...
If you are on macOS or Windows you can install a binary version of **TwoSampleMR** from our <https://mrcieu.r-universe.dev> with the following code.

```{r eval=FALSE}
install.packages("TwoSampleMR", repos = c("https://mrcieu.r-universe.dev", "https://cloud.r-project.org"))
```

If you are on the latest long term support version of Ubuntu you can install a binary version of TwoSampleMR with the following code.
...
To install directly from source from our GitHub repository do the following.
...
If you don't have the **remotes** package install it from CRAN using the following code.

```{r eval=FALSE}
install.packages("remotes")
```

And TwoSampleMR can also be installed in [WebR](https://docs.r-wasm.org/webr/latest/) using the following code.
