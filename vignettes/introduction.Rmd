...
If you are on the latest long term support version of Ubuntu (currently 24.04 Noble Numbat) you can install a binary version of TwoSampleMR with the following code.
